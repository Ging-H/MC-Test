...
public:
    ...
    static void listBaudRate(QComboBox *cbbBaud,qint32 dummy);
    static void listDataBit(QComboBox *cbbDataBit,  qint32 dummy);
    static void listVerify(QComboBox *cbbVerify, qint32 dummy);
...
//    static void verifyCon?stant  (QByteArray &buf,  qint32 size);
    QByteArray insertVerify(QByteArray &buf, int start = 1, int end = 0, int VerifyStyle = UnknownStyle);
